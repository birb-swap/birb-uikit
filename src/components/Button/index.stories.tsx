...
export const Anchors: React.FC = () => {
  return (
    <>
            ...
            <Box key={variant} mb="32px">
              {Object.values(scales).map((scale) => {
                return (
                  <Button
                    as="a"
                    href="https://swap.bitbucks.finance"
                    key={scale}
                    variant={variant}
                    scale={scale}
                    external
      ...
      <Box>
        <Button as="a" href="https://swap.bitbucks.finance" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://swap.bitbucks.finance" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
